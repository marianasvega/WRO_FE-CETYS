$${\color{blue}CETYS} \space FUTURE ENGINEERS 2024} 🤖
...
$${\color{lightblue}#CETYS} \space {\color{lightblue}FUTURE } \space {\color{lightgreen}Github}$$ - the correct way to write \color{color-name}
each \color{color-name} should be under separate one open and one closed curly brackets.
